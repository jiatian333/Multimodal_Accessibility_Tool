...
INPUT_STATION = 'Zürich, Zoo'

ARR = datetime(2025, 3, 23, 14, 30, 0).isoformat() # Arrival time -> set outside rush hour to prevent bias
...
NETWORK_AREA = "Zurich, Zurich, Switzerland" # Used area
...
TRANSPORT_STATIONS = DATA_PATH+"service_points.csv"
